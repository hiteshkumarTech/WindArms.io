...
> **v1 is the current stable build** — the playable game at `/play` is feature-complete and stable. **Correction (2026-07-14): the claim that v1 occupies the site root (windarms.com) is no longer accurate** — `src/app/page.tsx` now renders the V2 preview landing page (`LandingV2View`); the original v1 landing page still exists at `components/landing/LandingView.tsx` "for reference and rollback" but isn't what's served. The site's own footer copy states it correctly: *"Preview build — V1 remains live while V2 rises."* Read that as: v1 the *game* is live at `/play`; v1 the *landing page* is not currently what greets a visitor. **v2 ([v2.md](v2.md)) is where active development happens** — see the root [CLAUDE.md](../../CLAUDE.md); default new work there unless a request is explicitly about v1. This file remains the frozen, verbatim documentation of the v1 build (moved from the repository README during the docs restructure, 2026-07-12) and is the canonical record of "what v1 actually is" — the reference for the shipped game and for migrating patterns into v2. Nothing below has been reworded or summarized (the correction above is new framing, added around the frozen text, not an edit to it). Topic-sliced views of this same content live in [../technical/architecture.md](../technical/architecture.md), [../gameplay/mechanics.md](../gameplay/mechanics.md), [../gameplay/weapons.md](../gameplay/weapons.md), [../technical/networking.md](../technical/networking.md), [../technical/performance.md](../technical/performance.md), [../technical/deployment.md](../technical/deployment.md), [../technical/tech-stack.md](../technical/tech-stack.md) and [../technical/folder-structure.md](../technical/folder-structure.md) — these describe the gameplay codebase as it exists today (still v1 rules/netcode/combat, since v2 gameplay implementation hasn't started — v2's *landing/marketing* layer has, see [v2.md](v2.md)). If anything ever seems to conflict, this file wins for v1 gameplay facts.
>
